...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BLDSHARED': '/usr/bin/x86_64-linux-gnu-gcc -shared',
 'BOOTSTRAP_HEADERS': '\\',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'CONFIG_ARGS': "'--prefix=/yosyshq' '--host=x86_64-linux-gnu' "
                "'--build=x86_64-linux-gnu' '--disable-ipv6' '--enable-shared' "
                "'--with-ensurepip=no' "
                "'--with-build-python=/work/_builds/linux-x64/python3/python3-native/yosyshq/bin/python3.11' "
 ...
 'FREEZE_MODULE': '/work/_builds/linux-x64/python3/python3-native/yosyshq/bin/python3.11 '
                  './Programs/_freeze_module.py',
 ...
 'IO_OBJS': '\\',
 'LDCXXSHARED': '/usr/bin/x86_64-linux-gnu-g++ -shared',
 'LDFLAGS': '',
 'LDFLAGS_NODIST': '',
 'LDLIBRARY': 'libpython3.11.so',
 'LDLIBRARYDIR': '',
 'LDSHARED': '/usr/bin/x86_64-linux-gnu-gcc -shared',
 'LDVERSION': '3.11',
 'LIBC': '',
 ...
 'LIBPL': '/yosyshq/lib/python3.11/config-3.11-x86_64-linux-gnu',
 'LIBPYTHON': '',
 ...
 'LIBS': '-ldl',
 'LIBSUBDIRS': 'asyncio \\',
 'LINKCC': '/usr/bin/x86_64-linux-gnu-gcc',
 ...
 'MAINCC': '/usr/bin/x86_64-linux-gnu-gcc',
 'MAJOR_IN_MKDEV': 0,
 ...
 'PYTHONPATH': '',
 'PYTHON_FOR_BUILD': '_PYTHON_PROJECT_BASE=/work/_builds/linux-x64/python3/python3 '
                     '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
                     'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
                     '/work/_builds/linux-x64/python3/python3/`cat '
                     'pybuilddir.txt`:)./Lib '
                     '_PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__linux_x86_64-linux-gnu '
                     '/work/_builds/linux-x64/python3/python3-native/yosyshq/bin/python3.11',
 'PYTHON_FOR_BUILD_DEPS': 'python',
 'PYTHON_FOR_FREEZE': '/work/_builds/linux-x64/python3/python3-native/yosyshq/bin/python3.11',
 'PYTHON_FOR_REGEN': '',
 'PYTHON_HEADERS': '\\',
 'PYTHON_OBJS': '\\',
 ...
 'TESTPYTHON': 'LD_LIBRARY_PATH=/work/_builds/linux-x64/python3/python3 '
               '_PYTHON_PROJECT_BASE=/work/_builds/linux-x64/python3/python3 '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
               '/work/_builds/linux-x64/python3/python3/`cat '
               'pybuilddir.txt`:)./Lib '
